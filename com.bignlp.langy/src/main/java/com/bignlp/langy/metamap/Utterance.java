...
public interface Utterance extends MetaMapElement {
	...
	/**
	 * Return a list of {@link PCM} ({@link Phrase}/{@link Candidates}/
	 * {@link Mapping}s) container objects associated with the utterance.
	 * 
	 * @return a list of {@link PCM} (Phrase/Candidate/Mapping) container
	 *         objects.
	 */
