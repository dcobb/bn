...
public class PhraseImpl implements Phrase {
	...
	/**
	 * Return the result of the syntax analysis of the phrase by the minimal
	 * commitment parser See <a
	 * href="http://skr.nlm.nih.gov/papers/references/metamap.tech.pdf"> MetaMap
	 * Technical Notes, Preliminary processing
	...
	public String toString() {
		try {
			return "phrase: " + this.getPhraseText() + ","
					+ this.getMincoManAsString() + "," + this.getPosition();
		} catch (Exception e) {
