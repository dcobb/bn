...
/**
 * An interface for representing a MetaMap candidate term. A list of Ev terms
 * that are candidates for mapping.
 * <p>
 * 
 * <pre>
...
public interface Candidates extends MetaMapElement {
	...
	/**
	 * Return the list of candidate ({@link Ev}) instances associated with the
	 * {@link Candidates} instance.
	 * 
