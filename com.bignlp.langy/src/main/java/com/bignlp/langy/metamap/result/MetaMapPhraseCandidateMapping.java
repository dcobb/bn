...
public class MetaMapPhraseCandidateMapping  implements Serializable{
	...
	public MetaMapPhraseCandidateMapping() {
		super();
	}

	public MetaMapPhraseCandidateMapping(MetaMapPhrase argPhrase,
