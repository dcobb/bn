...
public final class MetaMapConfigConstants {
	...
	public static final List<Integer> PORTS = PORTS_10;

	public static final String MM_SERVER_HOME = "D:/bn/research/umls/public_mm_win32_main_2011v2/public_mm/";

	public static final String MM_SERVER_BIN = MM_SERVER_HOME + "bin/";
	public static final String MM_SERVER_EXE = "mmserver11v2.bat";
