 ...
 * @since 1.0
 * 
 *        History: version 3.0, May 3, 2006 changes: - Added support for MedPost
 *        and Penn Treebank tagged output
 * 
 *        version 2.0, June 9, 2005 changes: - Added support for prologfull and
 *        upcaret output formats
 * 
...
public class MmTaggerServer {
	 ...
	 * change.
	 */
	int serverPort = Integer.parseInt(System.getProperty("taggerserver.port",
			"1795"));
	...
	public MmTaggerServer() {
		...
		while (true) {
			try {
				...
				ClientTaggerThread aClientThread = new ClientTaggerThread(
						aClientSocket);
		...
		public void run() {
			...
			try {
				in = new BufferedReader(new InputStreamReader(
						localClientSocket.getInputStream()));
